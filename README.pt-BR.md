...
<p align="center">
  <a href="https://x.com/seekiee"><img src="docs/hero-banner.jpg" alt="Seekiee — Multi-Agent Job Search System" width="800"></a>
</p>
...
Seekiee transforma qualquer CLI de código com IA em uma central completa de busca de emprego. Em vez de acompanhar candidaturas manualmente em planilha, você tem um pipeline com IA que:
...
> **Importante: isso NÃO é uma ferramenta de disparo em massa.** Seekiee é um filtro -- ajuda você a encontrar as poucas vagas que realmente valem seu tempo entre centenas. O sistema recomenda fortemente não se candidatar a nada com nota abaixo de 4.0/5. Seu tempo é valioso, e o do recrutador também. Sempre revise antes de enviar.

Seekiee é agentic: Claude Code navega páginas de carreira com Playwright, avalia aderência comparando seu CV com a descrição da vaga (não por simples correspondência de palavras-chave) e adapta seu currículo para cada vaga.
...
Construído por alguém que usou isso para avaliar 740+ vagas, gerar 100+ CVs personalizados e conquistar uma posição de Head of Applied AI. [Leia o estudo de caso completo](https://darkiee.com/seekiee-system).
...
# 6. Comece a usar
# Cole a URL de uma vaga ou rode /seekiee
```
...
Seekiee é um único comando slash com múltiplos modos:

```
/seekiee                → Mostrar todos os comandos disponíveis
/seekiee {cole um JD}   → Auto-pipeline completo (avaliar + PDF + tracker)
/seekiee scan           → Escanear portais por novas vagas
/seekiee pdf            → Gerar CV otimizado para ATS
/seekiee batch          → Avaliar múltiplas vagas em lote
/seekiee tracker        → Ver status das candidaturas
/seekiee apply          → Preencher formulários de candidatura com IA
/seekiee pipeline       → Processar URLs pendentes
/seekiee outreach       → Mensagem de outreach no LinkedIn
/seekiee deep           → Pesquisa aprofundada da empresa
/seekiee training       → Avaliar um curso/certificação
/seekiee project        → Avaliar um projeto de portfólio
```

Ou apenas cole uma URL ou descrição de vaga diretamente -- seekiee detecta automaticamente e roda o pipeline completo.
...
- **[cv-santiago](https://github.com/seekiee/cv-santiago)** -- O site de portfólio (darkiee.com) com chatbot de IA, dashboard de LLMOps e estudos de caso. Se você precisa de um portfólio para acompanhar sua busca por vagas, faça um fork e adapte para você.

## Sobre o autor

Sou o Santiago -- Head of Applied AI, ex-fundador (criei e vendi uma empresa que ainda opera com meu nome). Eu construí o seekiee para gerenciar minha própria busca de emprego. Funcionou: usei o sistema para conquistar meu cargo atual.

Meu portfólio e outros projetos open source → [darkiee.com](https://darkiee.com)
...
<a href="https://www.star-history.com/?repos=05-deepak-patidar%2FSeekiee&type=timeline&legend=top-left">
 <picture>
   ...
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=seekiee/seekiee&type=timeline&legend=top-left" />
 </picture>
</a>

## Aviso legal

**seekiee é uma ferramenta local e open source — NÃO é um serviço hospedado.** Ao usar este software, você reconhece que:
