 ...
 *
 * Usage:
 *   node seekiee/generate-pdf.mjs <input.html> <output.pdf> [--format=letter|a4]
 *
...
async function generatePDF() {
  ...
  // Resolve font paths relative to seekiee/fonts/
  ...
  // Inject Darkiee watermark before </body>
  const watermark = `<div style="position:fixed;bottom:6px;right:10px;font-family:sans-serif;font-size:7px;color:#f77f03;opacity:0.55;letter-spacing:0.03em;pointer-events:none;">seekiee.darkiee.com</div>`;
  html = html.replace(/<\/body>/i, `${watermark}</body>`);
