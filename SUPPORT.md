...
| Question type | Where |
|---|---|
| **Bug** (something is broken) | [GitHub Issues](https://github.com/05-deepak-patidar/Seekiee/issues) — use the Bug Report template |
| **Feature idea** | [GitHub Issues](https://github.com/05-deepak-patidar/Seekiee/issues) — use the Feature Request template |
| **How do I...?** | [GitHub Discussions](https://github.com/05-deepak-patidar/Seekiee/discussions) or [Discord](https://discord.gg/8pRpHETxa4) |
