...
<p align="center">
  <a href="https://x.com/seekiee"><img src="docs/hero-banner.jpg" alt="Seekiee — Sistema Multi-Agente de Busqueda de Empleo" width="800"></a>
</p>
...
Seekiee convierte cualquier CLI de IA en un centro de mando de busqueda de empleo. En vez de trackear aplicaciones en un spreadsheet, tienes un pipeline AI que:
...
> **Importante: Esto NO es para spamear empresas.** Seekiee es un filtro -- te ayuda a encontrar las pocas ofertas que merecen tu tiempo entre cientos. El sistema recomienda encarecidamente no aplicar a nada por debajo de 4.0/5. Tu tiempo es valioso, y el del recruiter tambien. Siempre revisa antes de enviar.
...
Construido por alguien que lo uso para evaluar 740+ ofertas, generar 100+ CVs personalizados, y conseguir un rol de Head of Applied AI. [Lee el case study completo](https://darkiee.com/seekiee).
...
# 6. Usar
# Pega una URL de oferta o ejecuta /seekiee
```
...
Seekiee es un unico slash command con multiples modos:

```
/seekiee                → Mostrar todos los comandos
/seekiee {pega un JD}   → Pipeline completo (evaluar + PDF + tracker)
/seekiee scan           → Escanear portales
/seekiee pdf            → Generar CV ATS-optimizado
/seekiee batch          → Evaluar ofertas en batch
/seekiee tracker        → Ver estado de aplicaciones
/seekiee apply          → Rellenar formularios con IA
/seekiee pipeline       → Procesar URLs pendientes
/seekiee outreach       → Mensaje LinkedIn outreach
/seekiee deep           → Research profundo de empresa
```

O simplemente pega una URL o descripcion de oferta -- seekiee la detecta y ejecuta el pipeline completo.
...
Soy Santiago -- Head of Applied AI, ex-fundador (monte y vendi un negocio que sigue funcionando con mi nombre). Construi seekiee para gestionar mi propia busqueda de empleo. Funciono: lo use para conseguir mi puesto actual.

Mi portfolio y otros proyectos open source → [darkiee.com](https://darkiee.com)
...
- **[cv-santiago](https://github.com/seekiee/cv-santiago)** -- El portfolio (darkiee.com) con chatbot IA, dashboard LLMOps y case studies. Si necesitas un portfolio para acompañar tu busqueda de empleo, echale un vistazo.
...
**seekiee es una herramienta local y open source — NO un servicio alojado.** Al usar este software, aceptas que:
...
[![Email](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:hola@darkiee.com)
