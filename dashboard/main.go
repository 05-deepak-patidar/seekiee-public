...
import (
	...
	"seekiee/dashboard/internal/data"
	"seekiee/dashboard/internal/model"
	"seekiee/dashboard/internal/theme"
	"seekiee/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to seekiee directory")
	flag.Parse()
