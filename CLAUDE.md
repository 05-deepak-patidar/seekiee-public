# Seekiee -- AI Job Search Pipeline
...
- `{"status": "update-available", "local": "1.0.0", "remote": "1.1.0", "changelog": "..."}` → tell the user:
  > "seekiee update available (v{local} → v{remote}). Your data (CV, profile, tracker, reports) will NOT be touched. Want me to update?"
...
The user can also say "check for updates" or "update seekiee" at any time to force a check.
...
|---------|------------------------|-------------|
| `/seekiee` | `/seekiee` | Show menu or evaluate JD with args |
| `/seekiee-pipeline` | `/seekiee pipeline` | Process pending URLs from inbox |
| `/seekiee-evaluate` | `/seekiee evaluate` | Evaluate job offer (A-F scoring) |
| `/seekiee-compare` | `/seekiee compare` | Compare and rank multiple offers |
| `/seekiee-contact` | `/seekiee outreach` | LinkedIn outreach (find contacts + draft) |
| `/seekiee-deep` | `/seekiee deep` | Deep company research |
| `/seekiee-pdf` | `/seekiee pdf` | Generate ATS-optimized CV |
| `/seekiee-latex` | `/seekiee latex` | Export CV as LaTeX/Overleaf .tex |
| `/seekiee-training` | `/seekiee training` | Evaluate course/cert against goals |
| `/seekiee-project` | `/seekiee project` | Evaluate portfolio project idea |
| `/seekiee-tracker` | `/seekiee tracker` | Application status overview |
| `/seekiee-apply` | `/seekiee apply` | Live application assistant |
| `/seekiee-scan` | `/seekiee scan` | Scan portals for new offers |
| `/seekiee-batch` | `/seekiee batch` | Batch processing with parallel workers |
| `/seekiee-patterns` | `/seekiee patterns` | Analyze rejection patterns and improve targeting |
| `/seekiee-followup` | `/seekiee followup` | Follow-up cadence tracker |

**Note:** OpenCode commands invoke the same `.claude/skills/seekiee/SKILL.md` skill used by Claude Code. The `modes/*` files are shared between both platforms.
...
| `/seekiee` | `/seekiee` | Show menu or evaluate JD with args |
| `/seekiee-pipeline` | `/seekiee pipeline` | Process pending URLs from inbox |
| `/seekiee-evaluate` | `/seekiee evaluate` | Evaluate job offer (A-G scoring) |
| `/seekiee-compare` | `/seekiee compare` | Compare and rank multiple offers |
| `/seekiee-contact` | `/seekiee outreach` | LinkedIn outreach (find contacts + draft) |
| `/seekiee-deep` | `/seekiee deep` | Deep company research |
| `/seekiee-pdf` | `/seekiee pdf` | Generate ATS-optimized CV |
...
> - Run `/seekiee scan` (or `/seekiee-scan` if using OpenCode) to search portals
> - Run `/seekiee` to see all commands
>
...
If the user accepts, use the `/loop` or `/schedule` skill (if available) to set up a recurring `/seekiee scan` (or `/seekiee-scan` if using OpenCode). If those aren't available, suggest adding a cron job or remind them to run `/seekiee scan` (or `/seekiee-scan` if using OpenCode) periodically.
