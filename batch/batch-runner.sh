...
# seekiee batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
seekiee batch runner — process job offers in batch via claude -p workers
