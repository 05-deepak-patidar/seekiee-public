# seekiee — Українські режими (`modes/ua/`)

Цей каталог містить україномовні версії режимів seekiee для шукачів роботи, які працюють на українському ринку праці або з вакансіями на ринку України.
...
| `oferta.md`         | `modes/evaluate.md` (ES)         | Повна оцінка вакансії (блоки A-F)                                       |
