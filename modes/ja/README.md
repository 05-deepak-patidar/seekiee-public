# seekiee -- 日本語モード (`modes/ja/`)

このフォルダには、日本市場または日本語で運営される企業での求職活動を行う候補者向けに、seekiee の主要モードを日本語に翻訳したファイルが含まれています。
...
seekiee にはコード上の「言語スイッチ」フラグはありません。代わりに 2 つの方法があります：
...
| `kyujin.md` | `modes/evaluate.md` (ES) | 求人の完全評価（A-F ブロック） |
