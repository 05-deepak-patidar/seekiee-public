# seekiee -- Modes francophones (`modes/fr/`)

Ce dossier contient les traductions francaises des principaux modes seekiee pour les candidats qui ciblent le marche francophone (France, Belgique, Suisse romande, Luxembourg, Quebec).
...
| `offre.md` | `modes/evaluate.md` (ES) | Evaluation complete d'une offre (Blocs A-F) |
