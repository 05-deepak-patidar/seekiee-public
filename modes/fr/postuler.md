...
5. **seekiee proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/seekiee outreach` pour du LinkedIn outreach vers le hiring manager
