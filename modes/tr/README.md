# seekiee — Türkçe Modlar (`modes/tr/`)

Bu klasör, Türkiye iş piyasasında iş arayanlar veya Türkçe ilanlarla çalışanlar için seekiee modlarının Türkçe çevirilerini içerir.
...
| `is-ilani.md` | `modes/evaluate.md` (ES) | Tek bir ilanın tam değerlendirmesi (Bloklar A-G) |
