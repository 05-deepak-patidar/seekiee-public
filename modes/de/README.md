# seekiee — Deutsche Modi (`modes/de/`)

Dieser Ordner enthält die deutschen Übersetzungen der wichtigsten seekiee-Modi für Bewerber:innen, die im DACH-Raum (Deutschland, Österreich, Schweiz) suchen oder mit deutschen Stellenanzeigen arbeiten.
...
seekiee hat keinen "Sprach-Schalter" als Code-Flag. Stattdessen gibt es zwei Wege:
...
| `angebot.md` | `modes/evaluate.md` (ES) | Vollständige Bewertung einer einzelnen Stellenanzeige (Blöcke A-F) |
