#!/usr/bin/env node
/**
 * gemini-eval.mjs — Gemini-powered Job Offer Evaluator for seekiee
 *
...
const PATHS = {
  ...
  evaluate:      join(ROOT, 'modes', 'evaluate.md'),
  // Canonical skill path
  skill:    join(ROOT, '.claude', 'skills', 'seekiee', 'SKILL.md'),
  cv:          join(ROOT, 'cv.md'),
...
if (args.length === 0 || args[0] === '--help' || args[0] === '-h') {
  console.log(`
╔══════════════════════════════════════════════════════════════════╗
║           seekiee — Gemini Evaluator (free-tier)             ║
╚══════════════════════════════════════════════════════════════════╝
...
// ---------------------------------------------------------------------------
const systemPrompt = `You are seekiee, an AI-powered job search assistant.
...
// ---------------------------------------------------------------------------
console.log('\n' + '═'.repeat(66));
console.log('  SEEKIEE EVALUATION — powered by Google Gemini');
