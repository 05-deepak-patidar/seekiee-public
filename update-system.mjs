...
const CANONICAL_REPO = 'https://github.com/05-deepak-patidar/Seekiee.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/05-deepak-patidar/Seekiee/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/05-deepak-patidar/Seekiee/releases/latest';
