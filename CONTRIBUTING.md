# Contributing to Seekiee

Thanks for your interest in contributing! Seekiee is built with Claude Code, and you can use it for development too.
...
- Report bugs via [Issues](https://github.com/05-deepak-patidar/seekiee-public/issues)
...
- **PRs that enable auto-submitting applications** without human review. seekiee is a decision-support tool, not a spam bot.
...
The "seekiee" name itself is governed by [TRADEMARK.md](TRADEMARK.md).
...
- [Join GitHub Discussions](https://github.com/05-deepak-patidar/seekiee-public/discussions) — fastest way to get answers and connect with other contributors
- [Open an issue](https://github.com/05-deepak-patidar/seekiee-public/issues)
