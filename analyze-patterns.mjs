#!/usr/bin/env node
/**
 * analyze-patterns.mjs — Rejection Pattern Detector for seekiee
 *
...
const APPS_FILE = existsSync(join(SEEKIEE, 'data/applications.md'))
...
function analyze() {
  ...
  const enriched = entries.map(e => {
    ...
    const reportPath = reportMatch ? join(SEEKIEE, reportMatch[1]) : null;
